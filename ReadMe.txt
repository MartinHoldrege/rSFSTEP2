...
1. Copy the weather database to the rSFSTEP2 folder.
2. Set the location of the weather database in the STEPWAT.Wrapper.MAIN_V3.R script of the StepWat_R_Wrapper_Parallel folder.
...
6. Run the call_sbatch_database.sh script.
7. Once the data is compiled into a sqlite database (for individual sites), edit the number of sites (variable site) and location (variable path) where you wish to collect the data, in the copydata.sh script.
8. Run the copydata.sh script.
