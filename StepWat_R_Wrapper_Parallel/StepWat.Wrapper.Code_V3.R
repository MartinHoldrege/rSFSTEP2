        ...
        if (GCM[g]=="Current") {
          ...
          if (dist.graz.flag == T) {
            ...
            for (rg in rgroups) {
              ...
              name.bmass.csv<-paste("bmassavg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              name.mort.csv<-paste("mortavg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              ...
              name.sw2.daily.slyrs.csv<-paste("sw2_daily_slyrs_agg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              name.sw2.daily.csv<-paste("sw2_daily_agg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              ...
              name.sw2.monthly.slyrs.csv<-paste("sw2_monthly_slyrs_agg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              name.sw2.monthly.csv<-paste("sw2_monthly_agg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              ...
              name.sw2.yearly.slyrs.csv<-paste("sw2_yearly_slyrs_agg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
              name.sw2.yearly.csv<-paste("sw2_yearly_agg.Site",s,GCM[g],dst,grz,intensity,soil,sp,"csv",sep=".")
